...
import { StudentCourse, fetchStudentsByCourse } from '@/api/Classroom/StudentsByCourse';
...
const AddAllExamenModal: React.FC<AddControlModalProps> = ({
  isOpen,
  onClose,
  courseId,
  classeId,
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="dark:text-gray-50 text-gray-600">
            Ajout de note Examen aux étudiants
          </DialogTitle>
        </DialogHeader>
...
export default AddAllExamenModal;