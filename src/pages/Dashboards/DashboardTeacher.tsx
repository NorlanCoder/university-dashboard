...
import CardDataStatsTeacher from '../../components/CardDataStatsTeacher';
import TableOneTeacher from '../../components/Teacher/TableOneTeacher';
import { fetchTeacher, TeacherData } from '@/api/teacher/dashboard';
import toast, { Toaster } from 'react-hot-toast';

const Dashboard: React.FC = () => {

  const [dataDashboard, setDataDashboard] = useState<TeacherData | undefined>();
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
        <CardDataStatsTeacher title="Total Classes" total={dataDashboard?.totalClass.toString()}>
        ...
        </CardDataStatsTeacher>
        <CardDataStatsTeacher title="Total Cours" total={dataDashboard?.totalcourse.toString()}>
          <svg className="text-[#1f2937] dark:fill-white" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
        ...
        <CardDataStatsTeacher title="Total Étudiants" total={dataDashboard?.totalstudent.toString()}>
          <svg className="text-[#1f2937] dark:fill-white" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
        ...
        {/* <CardDataStatsTeacher title="Total Users" total={dataDashboard?.totalClass.toString()} levelDown>
      ...
      <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        ...
        <div className="col-span-12 xl:col-span-12">
          <TableOneTeacher dataDashboard={dataDashboard} />
        </div>
      </div>
    </>
  );
