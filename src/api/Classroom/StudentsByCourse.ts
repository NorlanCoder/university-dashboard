const BASE_API_URL = '/api/admin/classes';
...
export const fetchStudentsByCourse = async (
  ...
  try {
    const url = `${BASE_API_URL}/${classId}/course/${courseId}?page=${page}&search=${search}`;
...
export const AddNoteOrExamStudentAllByCourse = async (
    classId: string,
    courseId: string,
    payload: NotePayload
  ): Promise<void> => {
    ...
    try {
      const url = `${BASE_API_URL}/${classId}/course/${courseId}`;
      const response = await fetch(url, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
...
export const AddNoteByStudentSelect = async (
    classId: string,
    courseId: string,
    studentId: string,
    control: number
    ...
    try {
      const url = `${BASE_API_URL}/${classId}/course/${courseId}/${studentId}`;
      const response = await fetch(url, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
